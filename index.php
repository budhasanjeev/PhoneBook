        ...
        <div id="container">
            ...
            <div class="jumbotron contact-div">
                <div style="margin-bottom: 1%">
                    <li id="add-contact" type="button" class="btn btn-info glyphicon glyphicon-pencil" data-toggle="modal" data-target="#insert-contact">Create New Contact</li>
                    <li id="add-contact" type="button" class="btn btn-info glyphicon glyphicon-import" data-toggle="modal" data-target="#insert-contact">Import Contacts from Excel</li>
                    <li id="add-contact" type="button" class="btn btn-info glyphicon glyphicon-export" data-toggle="modal" data-target="#insert-contact">Export Contacts to Excel</li>
                    <li id="add-contact" type="button" class="btn btn-info glyphicon glyphicon-download" data-toggle="modal" data-target="#insert-contact">Download Sample</li>
                </div>
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                echo '
                                    <tr id="'.$row["contact_id"].'">
                                        ...
                                        <td>
                                            <button id="edit-contact" type="button" class="glyphicon glyphicon-edit btn btn-primary " onclick="editContact('.$row["contact_id"].')" ></button>
                                            <button type="button" class="glyphicon glyphicon-minus-sign btn btn-danger" onclick="deleteContact('.$row["contact_id"].')" title="DELETE"></button>
                                            <button type="button" class="glyphicon glyphicon-send btn btn-success" onclick="sendMessage('.$row["contact_id"].')" title="MESSAGE"></button>
                                        </td>
                                    </tr>
                                ';
                            }
